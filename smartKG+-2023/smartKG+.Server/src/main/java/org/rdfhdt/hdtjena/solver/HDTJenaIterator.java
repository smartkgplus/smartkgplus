...
public class HDTJenaIterator extends NiceIterator<Triple> {
	...
	public Triple next() {
		...
		Triple t = new Triple(
				nodeDictionary.getNode((int)triple.getSubject(), TripleComponentRole.SUBJECT),
				nodeDictionary.getNode((int)triple.getPredicate(), TripleComponentRole.PREDICATE),
				nodeDictionary.getNode((int)triple.getObject(), TripleComponentRole.OBJECT)
			);
