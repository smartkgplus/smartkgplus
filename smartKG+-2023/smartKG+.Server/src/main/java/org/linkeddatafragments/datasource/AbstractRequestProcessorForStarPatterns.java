...
public abstract class AbstractRequestProcessorForStarPatterns<CTT,NVT,AVT>
            ...
            extends AbstractRequestProcessor.Worker
    {
        ...
        public long estimateCardinality() throws IllegalArgumentException {
            ...
            return estimateCardinality(spfRequest.getSubject(), spfRequest.getStars(), spfRequest.getBindings());
        }
        ...
        public double meanElementSize() throws IllegalArgumentException {
            ...
            return meanElementSize(spfRequest.getSubject(), spfRequest.getStars(), spfRequest.getBindings());
        }
                ...
                throws IllegalArgumentException
        {
            ...
            return createMetadataFragment( spfRequest.getSubject(),
                    spfRequest.getStars(),
                    spfRequest.getBindings(),
                    offset, limit, spfRequest.getRequestHash() );
        }

        abstract protected ILinkedDataFragment createMetadataFragment(
            final IStarPatternElement<CTT,NVT,AVT> subj,
            final List<Tuple<IStarPatternElement<CTT,NVT,AVT>, IStarPatternElement<CTT,NVT,AVT>>> stars,
            final List<Binding> bindings,
            final long offset,
