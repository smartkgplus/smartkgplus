...
public class AdjacencyList {
	...
	/**
	 * Find the last pos of the list first
	 *
	 * @param x
	 * @return
	 */
	...
	/**
	 * Find element second, in the list first
	 *
	 * @param x
	 * @param y
	 * @return
	...
	public final long find(long x, long y) {
		...
		long begin = find(x);
		long end = last(x);
		// Binary search second within the list
		return binSearch(y, begin, end);
	}

	/**
	 * Find to which list first does the element at globalpos belongs
	 *
	 * @param globalpos
	 * @return
	 */
	...
	/**
	 * Count the number of items in list first
	 *
	 * @param x
	 * @return
	 */
