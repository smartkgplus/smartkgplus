...
public class BitmapTriples implements TriplesPrivate {
	...
	public BitmapTriples(HDTOptions spec) {
		...
		bitmapY = BitmapFactory.createBitmap(spec.get("bitmap.second"));
		bitmapZ = BitmapFactory.createBitmap(spec.get("bitmap.z"));

		seqY = SequenceFactory.createStream(spec.get("seq.second"));
...
//		adjZ.dump();
	...
	@Override
	public IteratorsTripleID searchStar(ArrayList<TripleID> pattern) {
		return new BitmapTriplesIteratorStar(this,pattern);
	}
