...
public class TripleString {
    ...
    public Statement getAsStatement() {
        Resource subj = this.valueFactory.createIRI(this.subject.toString());
        IRI pred = this.valueFactory.createIRI(this.predicate.toString());
        String objString = this.object.toString();
        Object obj;
        if (objString.matches("^(https?|ftp|file)://[-a-zA-Z0-9+&@#/%?=~_|!:,.;]*[-a-zA-Z0-9+&@#/%=~_|]")) {
            obj = this.valueFactory.createIRI(objString);
        } else {
            obj = this.valueFactory.createLiteral(objString);
        }

        return this.valueFactory.createStatement(subj, pred, (Value) obj);
    }
    ...
    public List<String> getVariables() {
        ...
        String pred = predicate.toString(), obj = object.toString();
