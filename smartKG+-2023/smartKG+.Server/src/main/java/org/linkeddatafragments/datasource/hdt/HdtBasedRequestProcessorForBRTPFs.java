...
public class HdtBasedRequestProcessorForBRTPFs
            ...
            extends AbstractRequestProcessorForBindingsRestrictedTriplePatterns.Worker<RDFNode,String,String>
    {
        ...
        protected long estimateCardinality(ITriplePatternElement<RDFNode, String, String> subject,
            ...
            //System.out.println("start Card Estimation");
            ...
            //System.out.println("End Card Estimation");
        ...
        private ILinkedDataFragment createFragmentByTriplePatternSubstitution(
            ...
            //System.out.println("createFragmentByTriplePatternSubstitution");
            final TripleIDCachingIterator it = new TripleIDCachingIterator(
                    bindings, foundVariables,
                    _subject, _predicate, _object);
            ...
            while (it.hasNext()) {
                ...
                //System.out.println("Triple ID:" + toTriple(t));
                final IteratorTripleID matches = datasource.getTriples().search(t);
                final boolean hasMatches = matches.hasNext();
                if (hasMatches) {
                    matches.goToStart();
                    //System.out.println("offset:" + offset);
                   // System.out.println("triplesCheckedSoFar: " + triplesCheckedSoFar);
                  
                    while (!(atOffset = (triplesCheckedSoFar == offset))
                            && matches.hasNext()) {
                        //System.out.println("match: " + matches.next().getPatternString());
                        triplesCheckedSoFar++;
                    }
           ...
           // System.out.print(triples.toString());
...
//         }
              ...
              //  System.out.println("A Threshold Else");
