    ...
    extends AbstractRequestProcessorForTriplePatterns<RDFNode,String,String>
{
       ...
       extends AbstractRequestProcessorForTriplePatterns.Worker<RDFNode,String,String>
    {
        ...
        @Override
        protected long estimateCardinality(ITriplePatternElement<RDFNode, String, String> subj, ITriplePatternElement<RDFNode, String, String> pred, ITriplePatternElement<RDFNode, String, String> obj) throws IllegalArgumentException {
            return 0;
        }

        @Override
        protected double meanElementSize(ITriplePatternElement<RDFNode, String, String> subj, ITriplePatternElement<RDFNode, String, String> pred, ITriplePatternElement<RDFNode, String, String> obj) throws IllegalArgumentException {
            return 0;
        }
