...
size_t SequentialSearchIteratorTripleID::estimatedNumSubjects(){
	return iterator->estimatedNumSubjects();
}

size_t SequentialSearchIteratorTripleID::estimatedNumPredicates(){
	return iterator->estimatedNumPredicates();
}
size_t SequentialSearchIteratorTripleID::estimatedNumObjects(){
	return iterator->estimatedNumObjects();
}
