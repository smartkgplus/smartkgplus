...
size_t TripleIDStringIterator::estimatedNumSubjects() {
	return iterator->estimatedNumSubjects();
}
size_t TripleIDStringIterator::estimatedNumPredicates() {
	return iterator->estimatedNumPredicates();
}
size_t TripleIDStringIterator::estimatedNumObjects() {
